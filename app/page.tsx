        ...
        <div className="relative container mx-auto px-6 py-20 md:py-32">
          <div className="text-center max-w-5xl mx-auto">
            ...
            <p className="text-xl text-gray-100 mb-12 max-w-3xl mx-auto leading-relaxed">
              Whether you're looking to master cutting-edge technologies or need
              expert digital solutions, we're here to elevate your journey.
            </p>
        ...
        <div className="container mx-auto px-6">
          <div className="rounded-2xl border border-gray-200 bg-white p-12 text-center">
            ...
            <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
              Whether you want to learn or build, we're here to help you
              succeed.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="/academy"
                className="px-8 py-4 bg-black hover:bg-gray-800 text-white rounded-lg font-medium transition-all duration-300"
              >
                Join Academy
              </a>
              <a
                href="/labs"
                className="px-8 py-4 border border-black hover:bg-gray-50 rounded-lg font-medium transition-all duration-300"
              >
                Hire Agency
              </a>
            </div>
      ...
      <footer className="border-t border-gray-200 py-12">
        <div className="container mx-auto px-6">
          ...
          <div className="border-t border-gray-200 pt-8 text-center text-sm text-gray-600">
            &copy; {new Date().getFullYear()} Code Illustrated. All rights
            reserved.
          </div>
        </div>
      </footer>
